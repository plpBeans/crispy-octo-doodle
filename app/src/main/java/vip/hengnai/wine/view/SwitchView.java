...
public class SwitchView extends View {
    private final int DEFAULT_COLOR_PRIMARY = Color.parseColor("#474342");//0xFF4BD763;
    private final int DEFAULT_COLOR_PRIMARY_DARK = Color.parseColor("#474342");//0xFF3AC652;
