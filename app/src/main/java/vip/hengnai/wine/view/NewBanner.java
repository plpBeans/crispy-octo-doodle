...
public class NewBanner extends FrameLayout implements ViewPager.OnPageChangeListener {
    ...
    private NewBanner.BannerPagerAdapter adapter;
    ...
    public NewBanner setBannerAnimation(Class<? extends ViewPager.PageTransformer> transformer) {
        try {
     ...
     * @return Banner
     */
    public NewBanner setPageTransformer(boolean reverseDrawingOrder, ViewPager.PageTransformer transformer) {
    ...
    private void createIndicator() {
        ...
        for (int i = 0; i < count; i++) {
            ...
            LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(mIndicatorWidth/2, mIndicatorHeight);
            params.leftMargin = mIndicatorMargin;
            params.rightMargin = mIndicatorMargin;
            LinearLayout.LayoutParams params1 = new LinearLayout.LayoutParams(mIndicatorWidth, mIndicatorHeight);
            params1.leftMargin = mIndicatorMargin;
            params1.rightMargin = mIndicatorMargin;
            if (i == 0) {
    ...
    private void setData() {
        currentItem = 1;
        if (adapter == null) {
            adapter = new NewBanner.BannerPagerAdapter();
...
//        Log.i(tag,"currentItem: "+currentItem);
    ...
    public void onPageSelected(int position) {
        ...
        if (bannerStyle == BannerConfig.CIRCLE_INDICATOR ||
            ...
            indicatorImages.get((position - 1 + count) % count).setLayoutParams(params1);
