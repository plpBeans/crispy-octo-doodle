...
public class TouchStarBar extends View {
    /**
     * 星星间距
     */
    ...
    public TouchStarBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public TouchStarBar(Context context, AttributeSet attrs, int defStyleAttr) {
