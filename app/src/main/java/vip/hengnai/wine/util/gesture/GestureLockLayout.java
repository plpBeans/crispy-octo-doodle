...
import vip.hengnai.wine.ui.login.SetGestureLockActivity;
...
public class GestureLockLayout extends RelativeLayout {
    ...
    private void init(final Context context) {
        ...
        mFingerTouchColor= ContextCompat.getColor(context, R.color.choose);
        mFingerUpMatchedColor= ContextCompat.getColor(context, R.color.choose);
        mFingerUpUnmatchedColor= Color.RED;
...
//                    return new QQLockView(context);
        ...
        mPaint.setStrokeWidth(GestureUtils.dp2px(context, mStrokeWidth));
    ...
    public void setPathWidth(float dp) {
        mPaint.setStrokeWidth(GestureUtils.dp2px(getContext(), dp));
    }
