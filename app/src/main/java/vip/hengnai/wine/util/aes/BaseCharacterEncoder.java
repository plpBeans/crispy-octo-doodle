 ...
 * </pre>
 * 
 * 51 * 52 * In the BaseCharacterEncoder and BaseCharacterDecoder classes, one complete
 ...
 * BaseCharacterDecoder; 72 * @see UCEncoder 73 * @see UUEncoder 74 * @see
 * Base64EncoderBase 75
 */
public abstract class BaseCharacterEncoder
{
	/**
	...
	/**
	 *the number of bytes per atom of encoding
	 * @return
	 */
	abstract protected int bytesPerAtom();

	/**
	 *the number of bytes that can be encoded per line
	 * @return
	 */
	...
	public String encode(byte[] aBuffer)
	{
		...
		} catch (Exception ioException)
		{
			...
			throw new Error("BaseCharacterEncoder.encode internal error");
		}
		return (retVal);
	}
	...
	public String encodeBuffer(byte[] aBuffer)
	{
		...
		{
			// This should never happen.
			throw new Error("BaseCharacterEncoder.encodeBuffer internal error");
		}
