 ...
 * @author Hugh
 */
public class OrderDetailProvider extends ItemViewProvider<OrderDetailEntity.ItemsBean, OrderDetailProvider.ProviderHolder> {

    private Context mContext;

    public OrderDetailProvider(Context mContext) {
    ...
    public interface OnClickListener {
         ...
         * @param itemsBean
         */
        void onItemClick(OrderDetailEntity.ItemsBean itemsBean);
    ...
    @Override
    protected void onBindViewHolder(@NonNull ProviderHolder holder, @NonNull OrderDetailEntity.ItemsBean itemsBean) {
